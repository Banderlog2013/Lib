...
/***/ "./src/js/lib/components/accodion.js":
/*!*******************************************!*\
  !*** ./src/js/lib/components/accodion.js ***!
  \*******************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    const closesElements = document.querySelectorAll(`${target} [data-close]`);
    closesElements.forEach(elem => {
...
/* harmony import */ var _components_accodion__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/accodion */ "./src/js/lib/components/accodion.js");
